...
def append(a, array, /, *, axis=0, blockwise_kwargs=None):
    ...
    if offset == 0:
        ...
        return _store_array(array, z, region=region, blockwise_kwargs=blockwise_kwargs)
    else:
        ...
        return _store_array(
            array_with_end_part, z, region=region, blockwise_kwargs=blockwise_kwargs
        )


def set_scalar(source: "Array", key, value, blockwise_kwargs=None):
